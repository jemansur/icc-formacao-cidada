...
if opcao == "Preencher ICC":
    ...
    with st.form("alimentar_banco_formulario"):
        ...
        salvar_tematica = st.form_submit_button("Salvar Nova Temática")
    ...
    if salvar_tematica:
        ...
        salvar_banco()
        st.success(f"Temática '{nova_tematica}' salva com sucesso!")

    if st.button("📋 Listar Banco Atual"):
        dados = []
